...
import org.rust.lang.core.macros.decl.FragmentKind.Companion.IDENTIFIER_TOKENS
...
private class TokenTreeParser(
    ...
    private fun parseLeaf(offset: Int, tokenType: IElementType, result: MutableList<TokenTree>) {
        ...
        when (tokenType) {
            ...
            in IDENTIFIER_TOKENS -> result += Leaf.Ident(tokenText, allocId(offset, tokenText.length))
            QUOTE_IDENTIFIER -> {
